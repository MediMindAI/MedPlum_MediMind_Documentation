...
1. **Theme Colors Reference (MANDATORY)**: `/Users/toko/Desktop/MedPlum_MediMind_Documentation-main/THEME_COLORS.md`
   - **Complete EMR color palette** - the authoritative source of truth
   - All `--emr-*` CSS custom properties
   - Primary blues, gradients, grays, text colors
   - Accessibility contrast ratios

2. **UI Component Library**: `/Users/toko/Desktop/medplum_medimind/explanations/ui-component-library.md`
   - 40+ standardized components you MUST use
   - EMRTable, EMRModal, EMRTabs, EMRButton, EMREmptyState, etc.

3. **Theme CSS**: `packages/app/src/emr/styles/theme.css`
   - Implementation of the color variables
